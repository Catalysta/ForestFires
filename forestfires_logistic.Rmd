...
cvfit1<-cv.glmnet(X, y, family = "binomial") #defaults to 10-fold cross validation per documentation
plot(cvfit1)
coef(cvfit1, s = "lambda.min")

cvfit2<-cv.glmnet(X, y, family = "binomial") #defaults to 10-fold cross validation per documentation
plot(cvfit2)
...
cvfit4<-cv.glmnet(X, y, family = "binomial", nfolds=5)
plot(cvfit4)
coef(cvfit4, s = "lambda.1se")
...
cvfit5<-cv.glmnet(X2, y, family = "binomial") #defaults to 10-fold cross validation per documentation
plot(cvfit5)
...
cvfit6<-cv.glmnet(X3, y, family = "binomial") #defaults to 10-fold cross validation per documentation
plot(cvfit6)
coef(cvfit6, s = "lambda.min")
...
cvfit7<-cv.glmnet(X4, y, family = "binomial") #defaults to 10-fold cross validation per documentation
plot(cvfit7)
